...
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88V448zM53.79 108.1C24.09 108.1 0 83.41 0 53.79S24.09 0 53.79 0s53.79 24.09 53.79 53.79-24.1 54.31-53.79 54.31zM447.8 448H354.9V302.4c0-34.7-.7-79.3-48.32-79.3-48.38 0-55.8 37.8-55.8 76.8V448h-92.7V148.9h89V184h1.3c12.4-23.4 42.6-48 87.8-48 93.9 0 111.2 61.8 111.2 142.3V448z"
      />
    </svg>
  );
};
